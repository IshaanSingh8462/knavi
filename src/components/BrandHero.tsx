function PineTree({ x, y, scale = 1 }: { x: number; y: number; scale?: number }) {
  return (
    <g transform={`translate(${x} ${y}) scale(${scale})`}>
      <rect x={-4} y={30} width="8" height="14" rx="2" fill="#6B4A2E" />
      <path d="M 0 -34 L 20 6 L -20 6 Z" fill="#1F4E2C" />
      <path d="M 0 -18 L 24 18 L -24 18 Z" fill="#1F4E2C" />
      <path d="M 0 -2 L 27 32 L -27 32 Z" fill="#2A6E3E" />
    </g>
  );
}
...
function Bush({ x, y, scale = 1 }: { x: number; y: number; scale?: number }) {
  return (
    <g transform={`translate(${x} ${y}) scale(${scale})`}>
      <circle cx="0" cy="0" r="16" fill="#2A6E3E" />
      <circle cx="-13" cy="7" r="12" fill="#2A6E3E" />
      <circle cx="14" cy="8" r="11" fill="#2A6E3E" />
    </g>
  );
}
...
function Rock({ x, y, scale = 1 }: { x: number; y: number; scale?: number }) {
  return (
    <g transform={`translate(${x} ${y}) scale(${scale})`}>
      <ellipse cx="0" cy="8" rx="20" ry="9" fill="#B7A98C" />
      <ellipse cx="16" cy="10" rx="11" ry="6" fill="#93805F" />
    </g>
  );
}
...
function Flower({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x} ${y})`} fill="#FBF8F1">
      <circle cx="0" cy="-5" r="3.2" />
      <circle cx="5" cy="0" r="3.2" />
      <circle cx="0" cy="5" r="3.2" />
      <circle cx="-5" cy="0" r="3.2" />
      <circle cx="0" cy="0" r="2.6" fill="#B98F4B" />
    </g>
  );
}
...
export default function BrandHero() {
  return (
    <svg viewBox="0 0 600 800" className="w-full h-full" preserveAspectRatio="xMidYMax slice" role="img" aria-hidden="true">
      ...
      {/* faint back peaks */}
      <path d="M -20 420 L 60 300 L 150 420 Z" fill="#D9C79A" opacity="0.7" />
      <path d="M 460 400 L 545 270 L 630 400 Z" fill="#D9C79A" opacity="0.7" />

      {/* mid green foothill peak (right) */}
      <path d="M 340 460 L 470 260 L 610 460 Z" fill="#4E8F63" />
      ...
      {/* meadow foreground */}
      <path d="M -20 800 L -20 560 C 120 480, 260 500, 300 560 C 360 500, 480 480, 620 560 L 620 800 Z" fill="#4E8F63" />
      ...
      <g stroke="#54503F" strokeWidth="3" strokeLinecap="round" fill="none">
